...
const AuthenticationPage = () => {
    ...
    return (
        <div>
            <div class="min-h-screen flex px-4 flex-col items-center justify-center bg-gray-100">
                <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-xl w-full max-w-md">
                    <div class="font-medium self-center text-xl sm:text-xl capitalize text-gray-500">Login To Your Account</div>
                    ...
                    <div class="mt-10">
                        <form onSubmit={handleLoginSubmit}>
                            <div class="flex flex-col mb-6">
                                <label for="number" class="mb-1 text-xs sm:text-md tracking-wide text-gray-600">Mobile Number</label>
                                <div class="relative space-y-4">
                                    ...
                                    <input id="number" type="number" name="number" class="text-sm sm:text-base placeholder-gray-500 rounded-lg border border-gray-400 w-full py-2 focus:outline-none px-2 focus:border-blue-400" placeholder="eg : +91 8565 1247 85" />
                                </div>
                            </div>
                            {/* <div class="flex flex-col mb-6">
                    ...
                    >
                        ...
                        <span class="ml-2 text-sm text-blue-700">You don't have an account?</span>
                    </div>
                </div>
            </div>
        </div>
